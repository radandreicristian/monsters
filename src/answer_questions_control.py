...
def answer_questions(image_generation_model_id: str,
    ...
    for _, concept_formulation in concepts.items():
        ...
        output_path = f"{images_root_path}/answers/{vqa_model}/{concept}.json"

        with open(output_path, "w") as f:
            json.dump(answer_counts, f)

        logger.info(f"Answers for {concept}: {answer_counts}")
